...
def generate_pdf(ids):
    ...
    for idx, id_value in enumerate(ids):
        ...
        # INNER CONTENT AREA
        inner_x = x + cell_padding_x
        inner_width = label_width - (2 * cell_padding_x)

        center_x = inner_x + inner_width / 2

        # ZONES (VERTICAL ADJUSTED SLIGHTLY FOR BALANCE)
        ...
        barcode_x = inner_x + (inner_width - barcode.width) / 2
